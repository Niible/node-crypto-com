...
export class CryptoPrivateApi extends CryptoApiBase {
  public async getAccountSummary(
    ...
    return this.post(PrivateMethod['get-account-summary'], params, true, {
  ...
  public async createOrder(
    ...
    return this.post(PrivateMethod['create-order'], params, true, {
  ...
  ): Promise<Response<CancelOrderResponse>> {
    return this.post(PrivateMethod['cancel-order'], params, true, {
      axios: this.createRateLimit(100, 15),
  ...
  public async cancelAllOrders(
    ...
    return this.post(PrivateMethod['cancel-all-orders'], params, true, {
      axios: this.createRateLimit(100, 15),
  ...
  public async getOrderHistory(
    ...
    return this.post(PrivateMethod['get-order-history'], params, true, {
  ...
  public async getOpenOrders(
    ...
    return this.post(PrivateMethod['get-open-orders'], params, true, {
      axios: this.createRateLimit(100, 3),
  ...
  public async getOrderDetail(
    ...
    return this.post(PrivateMethod['get-order-detail'], params, true, {
  ...
  ): Promise<Response<GetPrivateTradesResponse>> {
    return this.post(PrivateMethod['get-trades'], params, true, {
      axios: this.createRateLimit(1000, 1),
    }) as Promise<Response<GetPrivateTradesResponse>>;
  }
}
